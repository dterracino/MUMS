...
namespace MUMS.Web.Controllers {
    public partial class FeedController {
        ...
        public class ViewNames {
            public readonly string Html = "~/Views/Feed/Html.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_FeedController: MUMS.Web.Controllers.FeedController {
        ...
        public override System.Web.Mvc.ActionResult Html() {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Html);
            return callInfo;
        }
